...
function Footer() {
  ...
  return (
    ...
    <a href="https://www.tiktok.com" target="_blank" rel="noreferrer"><i className="fab fa-tiktok fa-2x text-dark mx-2 mt-2"></i></a>
    ...
    <div className='d-flex justify-content-center align-items-center'>
        <p>Call Us at <span className='number'>0712 345 679</span></p>
    </div>
</div>
    </>
  )
